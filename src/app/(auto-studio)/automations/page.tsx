        ...
        <>
            ...
            <div className="flex items-start gap-6">
                ...
                <div className="grow bg-slate-950 border border-slate-800 rounded-lg p-4">
                    ...
                    {!selectedId ? (
                        <p className="text-xs text-slate-500">Select an automation on the left.</p>
                    ) : (
                        <>
                ...
                <div className="flex-none bg-slate-950 border border-slate-800 rounded-lg p-4">
                    ...
                    {loadingRuns ? (
                        ...
                        <p className="text-xs text-slate-500">No runs yet for this automation.</p>
                    ) : (
                        <div className="space-y-2">
                            {runs.map((run) => (
                                <div key={run.id} className="border border-slate-800 rounded-md p-3 text-xs">
